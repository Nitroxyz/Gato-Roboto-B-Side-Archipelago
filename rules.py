...
def set_all_location_rules(world: GatoRobotoWorld) -> None:
    ...
    set_rule(current_location, lambda state: ((world.options.gato_tech == 3)) or (state.has("Progressive Vent Level", world.player, 3) and state.has("Rocket", world.player)) or (state.has("Progressive Vent Level", world.player, 3) and state.has("Spin Jump", world.player)))
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, world.options.aqueduct_goal) and state.has("Lava Cooled", world.player) and state.has("Progressive Vent Level", world.player, world.options.ventilation_goal)))
    ...
    set_rule(current_location, lambda state: (state.has("<Smallmech entry>", world.player)) or (state.has("Progressive Vent Level", world.player, 1)) or ((world.options.gato_tech == 3)))
    current_location = world.get_location("VHS (Ventilation-0517)")
    set_rule(current_location, lambda state: (state.has("Progressive Vent Level", world.player, 1)) or ((world.options.gato_tech >= 2) and state.has("<Smallmech entry>", world.player)) or ((world.options.gato_tech == 3)))
    ...
    if world.options.loresanity:
        ...
        set_rule(current_location, lambda state: (state.has("Progressive Vent Level", world.player, 3) and state.has("Rocket", world.player)) or (state.has("Progressive Vent Level", world.player, 3) and state.has("Spin Jump", world.player)) or ((world.options.gato_tech == 3)))
