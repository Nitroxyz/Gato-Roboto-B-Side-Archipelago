...
def set_all_entrance_rules(world: GatoRobotoWorld) -> None:
    ...
    set_rule(to_ventilation, lambda state: ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) <= 2) and state.has("Rocket", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 3) and (world.options.use_smallmech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 3) and state.has("Dash", world.player) and state.has("Rocket", world.player)))
...
def set_all_location_rules(world: GatoRobotoWorld) -> None:
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, world.options.aqueduct_goal.value) and state.has("Lava Cooled", world.player, world.options.heatercore_goal.value) and state.has("Progressive Vent Level", world.player, world.options.ventilation_goal.value)))
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 1) and state.has("Rocket", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)))
    current_location = world.get_location("VHS (Aqueducts-1106)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)))
    current_location = world.get_location("Health Upgrade (Aqueducts-1606)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and (world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)))
    current_location = world.get_location("VHS (Aqueducts-2106)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)))
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 3) and state.has("Rocket", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)))
    current_location = world.get_location("VHS (Aqueducts-0707)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 3) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)))
    ...
    if (world.options.gato_tech >= 3) and not world.options.use_smallmech:
        ...
        set_rule(current_location, lambda state: ((world.options.use_smallmech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)) or (state.has("Rocket", world.player) and state.has("Dash", world.player)) or (state.has("Spin Jump", world.player) and state.has("Dash", world.player)))
        current_location = world.get_location("Lava Cooled (Heater Core-0015)")
        set_rule(current_location, lambda state: ((world.options.use_smallmech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)) or (state.has("Rocket", world.player) and state.has("Dash", world.player)) or (state.has("Spin Jump", world.player) and state.has("Dash", world.player)))
    else:
        current_location = world.get_location("Cooler (Heater Core-0113)")
        set_rule(current_location, lambda state: ((world.options.use_smallmech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)) or (state.has("Dash", world.player) and state.has("Rocket", world.player)))
        current_location = world.get_location("Lava Cooled (Heater Core-0015)")
        set_rule(current_location, lambda state: ((world.options.use_smallmech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)) or (state.has("Dash", world.player) and state.has("Rocket", world.player)))
    ...
    set_rule(current_location, lambda state: (state.has("<Smallmech entry>", world.player)) or (state.has("Progressive Vent Level", world.player, 1)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 3)))
    current_location = world.get_location("VHS (Ventilation-0517)")
    set_rule(current_location, lambda state: (state.has("Progressive Vent Level", world.player, 1)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("<Smallmech entry>", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 3)))
    current_location = world.get_location("Vent Level (Ventilation-1122)")
    set_rule(current_location, lambda state: (state.has("<RightSide entry>", world.player) and state.has("Spin Jump", world.player)) or (state.has("<Smallmech entry>", world.player) and state.has("Spin Jump", world.player) and state.has("Dash", world.player) and state.has("Hopper", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("<RightSide entry>", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("<Smallmech entry>", world.player) and state.has("Spin Jump", world.player)))
    current_location = world.get_location("Health Upgrade (Ventilation-0815)")
    set_rule(current_location, lambda state: (state.has("Progressive Vent Level", world.player, 1)) or (state.has("<RightSide entry>", world.player)))
    ...
    set_rule(current_location, lambda state: (state.has("Spin Jump", world.player) and state.has("Dash", world.player) and state.has("Hopper", world.player)))
    ...
    if world.options.loresanity:
        ...
        set_rule(current_location, lambda state: (state.has("Spin Jump", world.player) and state.has("Rocket", world.player)) or (state.has("Spin Jump", world.player) and state.has("Dash", world.player)) or (state.has("Rocket", world.player) and state.has("Cooler", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("Rocket", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("Spin Jump", world.player)))
        current_location = world.get_location("Terminal (Nexus-2109)")
        set_rule(current_location, lambda state: (state.has("Progressive Vent Level", world.player, 3) and state.has("Rocket", world.player)) or (state.has("Progressive Vent Level", world.player, 3) and state.has("Spin Jump", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 3)))
        current_location = world.get_location("Terminal (Aqueducts-1006)")
        set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)) or ((world.options.use_watermech or (world.options.glitched_logic_display == 1 and state.has("UT Out of Logic", world.player))) and state.has("Rocket", world.player)))
        current_location = world.get_location("Terminal (Heater Core-2215)")
        set_rule(current_location, lambda state: state.has("Rocket", world.player))
        current_location = world.get_location("Terminal (Ventilation-1618)")
        set_rule(current_location, lambda state: (state.has("<RightSide entry>", world.player)))
        current_location = world.get_location("Terminal (Incubator-1514)")
        set_rule(current_location, lambda state: True)
