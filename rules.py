...
def set_all_location_rules(world: GatoRobotoWorld) -> None:
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 1) and state.has("Rocket", world.player)) or (world.options.use_watermech and state.has("Rocket", world.player)))
    current_location = world.get_location("VHS (Aqueducts-1106)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)) or (world.options.use_watermech and state.has("Rocket", world.player)))
    current_location = world.get_location("Health Upgrade (Aqueducts-1606)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or (world.options.use_watermech and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and state.has("Progressive Water Level", world.player, 2) and state.has("Rocket", world.player)) or ((world.options.gato_tech + (world.options.glitched_logic_display == 2 and state.has("UT Out of Logic", world.player)) >= 2) and world.options.use_watermech and state.has("Rocket", world.player)))
    ...
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 3) and state.has("Rocket", world.player)) or (world.options.use_watermech and state.has("Rocket", world.player)))
    current_location = world.get_location("VHS (Aqueducts-0707)")
    set_rule(current_location, lambda state: (state.has("Progressive Water Level", world.player, 3) and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)) or (world.options.use_watermech and state.has("Rocket", world.player) and state.has("Spin Jump", world.player)))
